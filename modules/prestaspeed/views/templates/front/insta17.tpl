...
{/if}
{if $psversion < "1.7.0.0" and $page.page_name != "index" or $psversion < "1.7.0.0" and $page.page_name != "index.php"}
 {literal}
<script type="text/javascript">
    $(document).ready(function(){
...
{if $speedfacebook eq 1 and $facebookurl != null}
<div id="fb-root"></div>
<div id="facebook_block" class="col-xs-4">
	<h4 >{l s='Follow us on Facebook' mod='prestaspeed'}</h4>
