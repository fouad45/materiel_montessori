...
<div class="container">
<section class="brands hb-animate-element left-to-right">
	<h2 class="h1 products-section-title text-uppercase">
		{if $display_link_brand}<a href="{$page_link}" title="{l s='Our Brands' mod='pst_brandlogo'}">{/if}
			{l s='' mod='pst_brandlogo'}
