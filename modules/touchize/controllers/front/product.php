...
class TouchizeProductModuleFrontController extends ModuleFrontController
{
    /**
    ...
    {
        $productId = (int)TouchizeControllerHelper::getParam('Id');
        ...
        $this->ajaxDie(Tools::jsonEncode($helper->getProduct($productId)));
    }
