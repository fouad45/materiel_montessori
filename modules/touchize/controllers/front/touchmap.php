...
class TouchizeTouchmapModuleFrontController extends ModuleFrontController
{
    /**
    ...
    {
        $idCategory = TouchizeControllerHelper::getParam('taxonId');
        $helper = new TouchizeTouchmapHelper();
        $response = $helper->getTouchmaps($idCategory);
