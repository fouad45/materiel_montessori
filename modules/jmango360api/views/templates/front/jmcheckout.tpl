        ...
        <ul class="opc" id="checkoutSteps">
            <li id="opc-billing" class="panel section {if selected_invoice_address_id}allow{/if}">
                ...
                <div id="checkout-step-billing" role="tabpanel" class="step a-item collapse"
                    ...
                    <form id="co-billing-form"
                          action="{$linkJm->getModuleLink("jmango360api", "jmcheckoutold")|escape:'htmlall':'UTF-8'}">
                        <fieldset>
                            <ul class="form-list">
                                {if $is_logged}
                                    <li class="wide">
                                ...
                                <li id="billing-new-address-form">
                                     {include file="$template_dir/billing-address-form.tpl"}
                                </li>
            ...
            <li id="opc-shipping" class="panel section {if selected_delivery_address_id}allow{/if}">
                ...
                <div id="checkout-step-shipping" role="tabpanel" class="step a-item collapse"
                     style="height: 0px;" aria-expanded="false">
                    <form action="{$linkJm->getModuleLink("jmango360api", "jmcheckoutold")|escape:'htmlall':'UTF-8'}"
                          id="co-shipping-form">
                        <ul class="form-list">
                            ...
                            <li id="shipping-new-address-form">
                                {include file="$template_dir/shipping-address-form.tpl"}
                            </li>
                            <li class="control">
...
<script type="text/javascript">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        billing = new Billing('co-billing-form',
            "{$linkJm->getModuleLink("jmango360api", "jmcheckoutold")|escape:'quotes':'UTF-8'}",
            customer,
            addresses,
            countries,
            current_country);
        ...
        shippingMethod = new ShippingMethod('co-shipping-method-form', "{$linkJm->getModuleLink("jmango360api", "jmcheckoutold")|escape:'quotes':'UTF-8'}");
        paymentMethod = new PaymentMethod('co-payment-form', "{$linkJm->getModuleLink("jmango360api", "jmcheckoutold")|escape:'quotes':'UTF-8'}");
        review = new Review('co-payment-form', 'checkout-agreements', "{$linkJm->getModuleLink("jmango360api", "jmcheckoutold")|escape:'quotes':'UTF-8'}");
        coupon = new Coupon('co-coupon-form', "{$linkJm->getModuleLink("jmango360api", "jmcheckoutold")|escape:'quotes':'UTF-8'}");
