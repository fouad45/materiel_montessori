    ...
    public static function provide($request)
    {
        ...
        switch ($requestResource) {
            ...
            case self::match(ApiConfig::UPDATE_ORDER, $requestResource):
                ...
                break;
            case self::match(ApiConfig::PWA_SETTING, $requestResource):
                $serviceClass = new PwaSettingService($module_name);
                break;
            case self::match(ApiConfig::PWA_MODE, $requestResource):
                $serviceClass = new PwaModeService($module_name);
                break;
            case self::match(ApiConfig::PWA_MANIFEST, $requestResource):
                $serviceClass = new PwaManifestService($module_name);
                break;
            case self::match(ApiConfig::PWA_ENDPOINT, $requestResource):
                $serviceClass = new PwaEndpointService($module_name);
                break;
            case self::match(ApiConfig::RESET_PASSWORD, $requestResource):
                $serviceClass = new ResetPasswordService($module_name);
                break;
            case self::match(ApiConfig::CART_ORDERS, $requestResource):
                $serviceClass = new CartOrderService($module_name);
                break;
            case self::match(ApiConfig::SUBMIT_NATIVE_ORDER, $requestResource):
                $serviceClass = new SubmitNativeOrderService($module_name);
                break;
            case self::match(ApiConfig::UPDATE_NATIVE_ORDER, $requestResource):
                $serviceClass = new UpdateNativeOrderService($module_name);
                break;
            case self::match(ApiConfig::GET_ORDER_DETAILS, $requestResource):
                $serviceClass = new GetOrderDetailsService($module_name);
                break;
        }
        return $serviceClass;
    }
