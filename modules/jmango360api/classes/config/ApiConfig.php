...
class ApiConfig
{
    ...
    //pwa settings
    const PWA_SETTING = 'pwa/setting';
    const PWA_MODE = 'pwa/mode';
    const PWA_ENDPOINT = 'pwa/endpoint';
    const PWA_MANIFEST = 'pwa/manifest';
    const RESET_PASSWORD = 'resetPassword';
    const CART_ORDERS = 'carts/orders/list';

    //native payment
    const SUBMIT_NATIVE_ORDER = 'submit-order-native';
    const UPDATE_NATIVE_ORDER = 'update-order-native-status';
    const GET_ORDER_DETAILS = 'orders/{id_order}';
}
