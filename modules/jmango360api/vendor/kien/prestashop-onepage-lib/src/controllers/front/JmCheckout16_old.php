...
class JmCheckout16_old extends ModuleFrontController
{
    ...
    public function initContent()
    {
        ...
        $checkout_url = __PS_BASE_URI__ . 'index.php?fc=module&module=' . $this->module_name . '&controller=jmcheckoutold';
...
//                            }
    ...
    public function setMedia()
    {
        ...
        $this->addCSS($this->module_dir . 'views/css/bootstrap.css');
        ...
        $this->addJS($this->module_dir . 'vendor/kien/prestashop-onepage-lib/src/views/js/jmcheckout.js?v=1');
    ...
    protected function loadPayments(
            ...
            foreach ($methods as $module) {
                ...
                if (is_callable(array($module_instance, 'hookpayment')) || is_callable(array($module_instance, 'hookDisplayPayment'))) {
                    ...
                    if (!$module_instance->currencies ||
                        ...
                        if (!empty($html)) {
                            $paymentsResult = CommonUtils::parsePaymentFromHtml($html);
        ...
        if (!count($this->errors)) {
            ...
            $payment_html = $this->context->smarty->fetch(_PS_MODULE_DIR_ . $this->module_name .
                '/vendor/kien/prestashop-onepage-lib/src/views/templates/front/' . $this->module_name . '/payment-methods.tpl');
        }
    ...
    private function updatePayment()
    {
        ...
        if (empty($this->errors)) {
            ...
            $cart_summary_html = $this->context->smarty->fetch(_PS_MODULE_DIR_ . $this->module_name .
                '/vendor/kien/prestashop-onepage-lib/src/views/templates/front/' . $this->module_name . '/cart-summary.tpl');
        }
        ...
        $temp_vars = array(
            ...
            'carrier_block' =>
                $this->context->smarty->fetch(_PS_MODULE_DIR_ . $this->module_name .
                    '/vendor/kien/prestashop-onepage-lib/src/views/templates/front/' . $this->module_name . '/shipping-methods.tpl'),
    ...
    private function initFormFieldBillingAddress($id_country)
    {
        ...
        if ($this->isAjax()) {
            ...
            if (Tools::getValue('step') == 'billing') {
                ...
                $output = $this->context->smarty->fetch(_PS_MODULE_DIR_ . $this->module_name . '/vendor/kien/prestashop-onepage-lib/src/views/templates/front/' . $this->module_name . '/shipping-address-form.tpl');
            }
            $this->context->smarty->assign('output', ($output));
...
//            }
    ...
    private function getAddressFormFields($type, $id_country = null)
    {
        ...
        $html = '';
        try {
            $html = $smarty->fetch(_PS_MODULE_DIR_ . $this->module_name . '/vendor/kien/prestashop-onepage-lib/src/views/templates/front/' . $this->module_name . '/shipping-address-form.tpl');
        } catch (Exception $e) {
            ob_end_clean();
