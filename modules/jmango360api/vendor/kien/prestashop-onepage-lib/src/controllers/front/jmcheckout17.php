...
class JmCheckout17 extends ModuleFrontController
{
    ...
    {
        $this->context->smarty->addTemplateDir(_PS_MODULE_DIR_ . $this->module_name .'/vendor/kien/prestashop-onepage-lib/src/views/templates/front/'.$this->module_name);
...
//$_SERVER['HTTP_HOST'].$this->module->getPathUri().$this->;
        ...
        $this->setTemplate('module:'.$this->module_name.'/vendor/kien/prestashop-onepage-lib/src/views/templates/front/'.$this->module_name.'/onepage17/jmcheckout.tpl');
    }
    ...
    protected function loadAddressForm()
    {
        ...
        try {
            $tpl = $this->context->smarty->createTemplate(
                'modules/'.$this->module_name.'/vendor/kien/prestashop-onepage-lib/src/views/templates/front/'.$this->module_name.'/onepage17/_partials/address-form.tpl',
                $scope
            );
