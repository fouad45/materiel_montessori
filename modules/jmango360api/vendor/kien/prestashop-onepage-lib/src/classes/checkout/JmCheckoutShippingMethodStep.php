...
class JmCheckoutShippingMethodStep extends JmCheckoutStep
{
    ...
    public function __construct(
        ...
        $this->template = 'module:'.$checkoutController->module_name.'/vendor/kien/prestashop-onepage-lib/src/views/templates/front/'.$checkoutController->module_name.'/onepage17_new/steps/step3-shipping-method.tpl';
