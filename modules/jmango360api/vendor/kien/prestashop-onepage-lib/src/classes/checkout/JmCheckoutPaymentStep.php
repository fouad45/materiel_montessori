...
class JmCheckoutPaymentStep extends JmCheckoutStep
{
    ...
    public function __construct(
        ...
        $this->template = 'module:'.$module_name.'/vendor/kien/prestashop-onepage-lib/src/views/templates/front/'.$module_name.'/onepage17_new/steps/step4-payment-method.tpl';
