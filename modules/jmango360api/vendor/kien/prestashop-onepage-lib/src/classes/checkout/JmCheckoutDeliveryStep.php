...
class JmCheckoutDeliveryStep extends JmCheckoutStep
{
    ...
    public function render(array $extraParams = array())
    {
        ...
        if (Module::isEnabled('soflexibilite')){
            $hookDisplayFooter = Hook::exec('displayAfterBodyOpeningTag', array('cart' => $this->getCheckoutSession()->getCart()));
        ...
        $hookDisplayFooter = htmlspecialchars_decode($hookDisplayFooter);
        ...
        return $this->renderTemplate(
            ...
            array(
                ...
                'hookDisplayFooter' => $hookDisplayFooter,
                ...
                'initChronopost' => Module::isEnabled('chronopost')
            )
        );
    }
