...
class JmCheckoutShippingAddressStepOld extends JmCheckoutStep
{
    ...
    public function __construct(
        ...
        FinalJmCheckout17_old $checkoutController
    ) {
        ...
        $this->template = 'module:'.$checkoutController->module_name.'/vendor/kien/prestashop-onepage-lib/src/views/templates/front/'.$checkoutController->module_name.'/onepage17/_partials/shipping-address-form.tpl';
