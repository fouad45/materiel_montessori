...
class JmCheckoutPaymentStepOld extends JmCheckoutStep
{
    protected $template;
    ...
    public function __construct(
        ...
        $this->template = 'module:'.$module_name.'/vendor/kien/prestashop-onepage-lib/src/views/templates/front/'.$module_name.'/onepage17/steps/payment.tpl';
