...
class JMCheckoutBillingAddressStepOld extends JmCheckoutStep
{
    protected $template;
    ...
    public function __construct(
        ...
        $this->template = 'module:'.$checkoutController->module_name.'/vendor/kien/prestashop-onepage-lib/src/views/templates/front/'.$checkoutController->module_name.'/onepage17/_partials/address-form.tpl';
