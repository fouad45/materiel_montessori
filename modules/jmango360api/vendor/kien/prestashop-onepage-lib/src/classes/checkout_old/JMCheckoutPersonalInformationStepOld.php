...
class JMCheckoutPersonalInformationStepOld extends JmCheckoutStep
{
    protected $template;
    ...
    public function __construct(
        ...
        FinalJmCheckout17_old $controller
    ) {
        $this->template = 'module:'.$controller->module_name.'/vendor/kien/prestashop-onepage-lib/src/views/templates/front/'.$controller->module_name.'/onepage17/_partials/customer-form.tpl';
