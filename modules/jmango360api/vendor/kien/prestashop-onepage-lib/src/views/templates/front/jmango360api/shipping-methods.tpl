                            ...
                            <dt class="carrier-id-{$key|intval}">
                                ...
                                <label for="shipping_method_{$id_address|intval}_{$option@index|intval}">
                                    ...
                                    {if $option.unique_carrier && isset($carrier.instance->delay[$cookie->id_lang])}
                                        <p>
                                            <span class="desc-shipping-label">{l s='Delivery time:' mod='jmango360api'}</span>
                                            <span class="desc-shipping">{$carrier.instance->delay[$cookie->id_lang]|escape:'htmlall':'UTF-8'}</span>
                                        </p>
                                    {/if}
                                    {if count($option_list) > 1}
                                        <p class="desc-shipping-sub">
