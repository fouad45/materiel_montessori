        ...
        <ol class="opc" id="checkoutSteps">
                        ...
                        <fieldset>
                            <ul class="form-list">
                                    ...
                                    <li class="wide">
                                        ...
                                        <div class="input-box">
                                            ...
                                            <div class="japi-address-edit" style="display: none">
                                                <a href="#" class="japi-address-edit-btn">{l s='Edit' mod='jmango360api'}</a>
                                            </div>
                                        </div>
                                    </li>
                                {else}
                                    ...
                                    <fieldset class="">
                                        ...
                                        <ul>
                                            <li class="wide" style="{if $is_logged eq 1}display:none{/if}">
                                                <div class="field">
                                                    <label for="billing:gender_id">{l s='Title' mod='jmango360api'}</label>
                                                    <div class="input-box">
                                            ...
                                            <li class="wide">
                                                <div class="field name-firstname">
                                                    <label for="billing:firstname" class="required">{l s='First name' mod='jmango360api'}</label>
                                                    <div class="input-box">
                                            ...
                                            <li class="wide">
                                                <div class="field name-lastname">
                                                    <label for="billing:lastname" class="required">{l s='Last name' mod='jmango360api'}</label>
                                                    <div class="input-box">
                                            ...
                                            <li class="fields" style="{if $is_logged eq 1}display:none{/if}">
                                                <label for="billing:days">{l s='Date of Birth' mod='jmango360api'}</label>
                                            ...
                                            <li class="fields">
                                                <div class="field input-company">
                                                    <label for="billing:company">{l s='Company' mod='jmango360api'}</label>
                                                    <div class="input-box">
                                            ...
                                            <li class="wide">
                                                <label for="billing:street1" class="required">{l s='Address' mod='jmango360api'}</label>
                                                <div class="input-box">
                                            ...
                                            <li class="fields">
                                                <div class="field">
                                                    <label for="billing:city" class="required">{l s='City' mod='jmango360api'}</label>
                                                    <div class="input-box">
                                                ...
                                                <div class="field" id="billing:state">
                                                    <label for="billing:state_id" class="required">{l s='State/Province' mod='jmango360api'}</label>
                                                    <div class="input-box">
                                                        <select id="billing:state_id" name="billing[state_id]" title="State/Province" class="validate-select">
                                                            <option value="">{l s='Please select region, state or province' mod='jmango360api'}</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="fields">
                                                ...
                                                {/if}
                                                <div class="field">
                                                    <label for="billing:country_id" class="required">{l s='Country' mod='jmango360api'}</label>
                                            ...
                                            <li class="fields">
                                                <div class="field">
                                                    <label for="billing:telephone" class="required">{l s='Mobile phone' mod='jmango360api'}</label>
                                                    <div class="input-box">
                                            ...
                                            <li class="fields" style="{if $is_logged eq 0}display: none{/if}">
                                                <div class="field">
                                                    <label for="billing:alias" class="required">{l s='Please assign an address title for future reference.' mod='jmango360api'}</label>
                                                    <div class="input-box">
                                                        <input type="text" name="billing[alias]" value="{l s='My address' mod='jmango360api'}" title="Alias" class="input-text  required-entry" id="billing:alias" data-validation="required">
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="fields" id="register-customer-password" style="display: none;">
                                                <div class="field">
                                                    <label for="billing:customer_password" class="required"><em>*</em>{l s='Password' mod='jmango360api'}</label>
                                                    <div class="input-box">
                                                ...
                                                <div class="field">
                                                    <label for="billing:confirm_password" class="required"><em>*</em>{l s='Confirm Password' mod='jmango360api'} </label>
                                                    <div class="input-box">
                                ...
                                <li class="control">
                                    ...
                                    <label for="billing:use_for_shipping_yes">{l s='Ship to this address' mod='jmango360api'}</label>
                                </li>
                                <li class="control">
                                    ...
                                    <label for="billing:use_for_shipping_no">{l s='Ship to different address' mod='jmango360api'}</label>
                                </li>
                            </ul>
                            ...
                            <li id="shipping-new-address-form">
                                <fieldset>
                                    ...
                                    <ul>
                                        ...
                                        <li class="fields">
                                            <div class="fields">
                                                <label for="shipping:company">{l s='Company' mod='jmango360api'}</label>
                                                <div class="input-box">
                                        ...
                                        <li class="fields">
                                            <div class="field">
                                                <label for="shipping:postcode" class="required">{l s='Zip/Postal Code' mod='jmango360api'}</label>
                                                <div class="input-box">
                                        ...
                                        <li class="fields">
                                            <div class="field">
                                                <label for="shipping:telephone" class="required">{l s='Mobile phone' mod='jmango360api'}</label>
                                                <div class="input-box">
                                        ...
                                        <li class="fields" style="{if $is_logged eq 0}display: none{/if}">
                                            <div class="field">
                                                <label for="shipping:alias" class="required">{l s='Assign an address alias for future reference.' mod='jmango360api'}</label>
                                                <div class="input-box">
                                                    <input type="text" name="shipping[alias]" value="{l s='My invoice address' mod='jmango360api'}" title="Alias" class="input-text  required-entry" id="shipping:alias" data-validation="required">
                                                </div>
                                            </div>
                                        </li>
                                        <li class="no-display">
            ...
            <li id="opc-shipping_method" class="panel section ">
                ...
                <div id="checkout-step-shipping_method" role="tabpanel" class="step a-item collapse" style="" aria-expanded="true">
                    {include file="$template_dir/shipping-methods.tpl"}
                </div>
            </li>
            <li id="opc-payment" class="panel section ">
                ...
                <div id="checkout-step-payment" role="tabpanel" class="step a-item collapse" style="height: 0px;" aria-expanded="false">
                    {include file="$template_dir/payment-methods.tpl"}
                </div>
            </li>
            <li id="opc-review" class="panel section ">
                ...
                <div id="checkout-step-review" role="tabpanel" class="step a-item collapse" style="height: 0px;" aria-expanded="false">
                    <div class="order-review" id="checkout-review-load">
                        {include file="$template_dir/cart-summary.tpl"}
                    </div>
                </div>
            </li>
        </ol>
