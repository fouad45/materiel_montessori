...
{capture assign='page_title'}{l s='Your address' mod='jmango360api'}{/capture}
...
<div data-role="content" id="content">
	<div>
		...
		<form action="{$link->getModuleLink("jmango360api", "address", array())|escape:'quotes':'UTF-8'}" method="post" id="add_address" data-ajax="false">
			<legend><h3>{if isset($id_address) && $id_address != 0}{l s='Your address' mod='jmango360api'}{else}{l s='New address' mod='jmango360api'}{/if}</h3></legend>
			<div class="required text dni">
				...
				<p>{l s='DNI / NIF / NIE' mod='jmango360api'} <sup>*</sup></p>
				<label for="dni">{l s='Identification number' mod='jmango360api'}</label>
				<input type="text" class="text" name="dni" id="dni" value="{if isset($smarty.post.dni)}{$smarty.post.dni|escape:'html':'UTF-8'}{else}{if isset($address->dni)}{$address->dni|escape:'htmlall':'UTF-8'}{/if}{/if}" />
				<p>{l s='DNI / NIF / NIE' mod='jmango360api'} <sup>*</sup></p>
			</div>
			...
			<div id="vat_area">
				...
				<div id="vat_area" style="display: none;">
					...
					<p>{l s='You must register at least one phone number.' mod='jmango360api'} <sup class="required">*</sup></p>
					<div class="text">
					...
					<div class="text">
						<label for="phone_mobile">{l s='Mobile phone' mod='jmango360api'}</label>
					...
					<p class="required text" id="adress_alias">
						...
						<input type="text" id="alias" name="alias" value="{if isset($smarty.post.alias)}{$smarty.post.alias|escape:'html':'UTF-8'}{else if isset($address->alias)}{$address->alias|escape:'htmlall':'UTF-8'}{else if isset($select_address)}{l s='My address' mod='jmango360api'}{/if}" />
					</p>
					<div>
						...
						<button type="submit" data-theme="a" name="submitAddress" value="submit-value" id="submitAddress" >{l s='Save' mod='jmango360api'}</button>
					</div>
		</form>
	</div>
