...
<div class="box">
	<h1 class="page-subheading">{l s='Your addresses' mod='jmango360api'}</h1>
	<p class="info-title">
	...
	<form action="{$link->getModuleLink("jmango360api", "address", array())|escape:'quotes':'UTF-8'}" method="post" class="std" id="add_address">
		<!--h3 class="page-subheading">{if isset($id_address)}{l s='Your address' mod='jmango360api'}{else}{l s='New address' mod='jmango360api'}{/if}</h3-->
        ...
        {foreach from=$ordered_adr_fields item=field_name}
            {if $field_name eq 'company'}
				<div class="form-group">
					<label for="company">{l s='Company' mod='jmango360api'}{if isset($required_fields) && in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
            ...
            {if $field_name eq 'vat_number'}
				<div id="vat_area">
					<div id="vat_number">
						<div class="form-group">
							<label for="vat-number">{l s='VAT number' mod='jmango360api'}{if isset($required_fields) && in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
            ...
            {if $field_name eq 'address2'}
				<div class="required form-group">
					<label for="address2">{l s='Address (Line 2)' mod='jmango360api'}{if isset($required_fields) && in_array($field_name, $required_fields)} <sup>*</sup>{/if}</label>
            ...
            {if $field_name eq 'phone'}
				...
				<div class="form-group phone-number">
					<label for="phone">{l s='Home phone' mod='jmango360api'}{if isset($one_phone_at_least) && $one_phone_at_least} <sup>**</sup>{/if}</label>
		...
		<div class="required form-group" id="adress_alias">
			...
			<input type="text" id="alias" class="is_required validate form-control" data-validate="{$address_validation.alias.validate|escape:'html':'UTF-8'}" name="alias" value="{if isset($smarty.post.alias)}{$smarty.post.alias|escape:'html':'UTF-8'}{elseif isset($address->alias)}{$address->alias|escape:'html':'UTF-8'}{elseif !$select_address}{l s='My address' mod='jmango360api'}{/if}" />
		</div>
		<p class="submit2">
