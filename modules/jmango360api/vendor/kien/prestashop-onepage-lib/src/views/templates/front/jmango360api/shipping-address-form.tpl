...
<fieldset class="">
    ...
    {if $is_logged} {* Customer *}
        ...
        <ul id="address_form">
            ...
            {/if}
            <div class="form-group" id="shipping-other">
                <label for="other">
        ...
        <ul id="address_form">
                ...
                {elseif $field_name eq 'phone'}
                    ...
                    <li class="fields" id="phone">
                        <div id="shipping:phone" class="field">
                            ...
                            <div class="input-box">
                                <input class="{if isset($one_phone_at_least) && $one_phone_at_least}required{/if} input-text"
                ...
                {elseif $field_name eq 'phone_mobile'}
                    ...
                    <li class="fields" id="phone_mobile">
                        <div id="shipping:phone_mobile" class="field">
                            ...
                            <div class="input-box">
                                <input class="required input-text"
            ...
            {if !$mobilePhoneExist}
                <div class="{if isset($one_phone_at_least) && $one_phone_at_least}required{/if} form-group">
                    ...
                    <input class="required input-text"  type="tel" id="phone_mobile" name="shipping[phone_mobile]" value="" />
                </div>
            {/if}
