                    ...
                    {foreach from=$conditions_to_approve item="condition" key="condition_name"}
                        <li>
                            ...
                            <div class="condition-label">
                                <label class="js-terms" id="id_label_{$condition_name|escape:'html':'UTF-8'}"
                                       for="conditions_to_approve[{$condition_name|escape:'html':'UTF-8'}]">
                                    {$condition}
                                </label>
                            </div>
                        </li>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {if strlen($discount.code)}
                                                <i class="fa fa-trash"
                                                   onclick="coupon.remove('{$discount.id_discount|escape:'html':'UTF-8'}')"></i>
                                            {/if}
                                        </td>
                                    </tr>
                                {/foreach}
...
<script type="text/javascript">
    var review = new Review('co-payment-form', 'checkout-agreements', "{url entity='module' name='jmango360api' controller='jmcheckoutold' relative_protocol=false}");
    var coupon = new Coupon('co-coupon-form', '{url entity='module' name='jmango360api' controller='jmcheckoutold' relative_protocol=false}');
