            ...
            <ul id="address_form">
                {if !$is_logged}
                    ...
                    <li class="field control">
                        <input type="hidden" value="{$is_logged|escape:'html':'UTF-8'}" name="billing[is_logged]">
                    </li>
                    ...
                    <div class="clearfix"></div>
                        <li class="fields">
                            <div class="field">
                                ...
                                <input class="validate input-text" type="tel" id="phone_mobile" name="billing[phone_mobile]" value=""
                                    {if isset($one_phone_at_least) && $one_phone_at_least}
                                        data-validation="required"
                                    {/if}
                                />
