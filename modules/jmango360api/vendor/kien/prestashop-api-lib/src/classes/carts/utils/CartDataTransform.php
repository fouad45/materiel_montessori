...
class CartDataTransform extends BaseService
{
    ...
    public function present($cart)
    {
        ...
        $subtotals['products'] = array(
            'type' => 'products',
            'label' => $this->getTranslation('Subtotal', 'step5-order-review'),
        ...
        if ($total_discount) {
            $subtotals['discounts'] = array(
                'type' => 'discount',
                'label' => $this->getTranslation('Discount', 'step5-order-review'),
        ...
        $subtotals['shipping'] = array(
            'type' => 'shipping',
            'label' => $this->getTranslation('Shipping', 'step5-order-review'),
            'amount' => $shippingCost,
