...
class ElevateZoom extends Module
{
	...
	public function install()
	{
		...
		return (parent::install() &&
			...
			Configuration::updateValue('ELEVATEZOOM_EXTRA_PARAMS', 'borderSize:1,borderColour:\'#ebebeb\', zoomWindowWidth:466, zoomWindowHeight:466, zoomLevel:0.7,lensBorderSize:0') &&
