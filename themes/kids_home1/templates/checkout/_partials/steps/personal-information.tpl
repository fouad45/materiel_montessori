...
{block name='step_content'}
  ...
  {else}
    ...
    <ul class="nav nav-inline my-2" role="tablist">
      ...
      <li class="nav-item">
        <a
          ...
          role="tab"
          aria-controls="checkout-account-form"
          >
          {l s='Créer votre compte' d='Shop.Theme.Customeraccount'}
        </a>
      </li>
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane" id="checkout-account-form" role="tabpanel">
        {render file='checkout/_partials/account-form.tpl' ui=$register_form guest_allowed=$guest_allowed}
      </div>
